...
interface ProductImageUploaderProps {
  ...
  disabled?: boolean
  /** URLs que ya estaban en la DB al abrir el form: no borrar del bucket al quitar del grid (se limpian al guardar). */
  persistedImageUrls?: Set<string>
}
...
export default function ProductImageUploader({
  ...
  const handleRemove = async (image: UploaderImage) => {
    ...
    if (persistedImageUrls?.has(image.url)) return
    try {
